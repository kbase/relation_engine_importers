...
if __name__ == '__main__':
    ...
    output_json_rxn_reaction_within_complex(
        os.path.join(output_dir, 'kegg_rxn_reaction_within_complex.json'))
    output_json_rxn_gene_within_complex(
        os.path.join(output_dir, 'kegg_rxn_gene_within_complex.json'))
